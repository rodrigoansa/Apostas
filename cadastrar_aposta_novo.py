...
def funcao_principal():
    ...
    box = cadastro.comboBox.currentText()
    box_1 = cadastro.comboBox_1.currentText()
    box_2 = cadastro.comboBox_2.currentText()
    box_3 = cadastro.comboBox_3.currentText()
    box_4 = cadastro.comboBox_4.currentText()
    box_5 = cadastro.comboBox_5.currentText()
    box_6 = cadastro.comboBox_6.currentText()
    box_7 = cadastro.comboBox_7.currentText()
